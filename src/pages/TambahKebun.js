...
const TambahKebun = () => {
    ...
    const tambahKebun = async(e) => {
        ...
        fetch('http://127.0.0.1:8000/api/kebun/tambah?token='+sessionStorage.getItem('token'), {
            method: 'POST',
            body: formData, // Menggunakan FormData sebagai tubuh permintaan
        })
        .then(data=>data.json())
        .then(Response=>{
                    ...
                    <Header/>
                        <div class="content-wrapper">
                            ...
                            <div class="container-xxl flex-grow-1 container-p-y">
                                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pages /</span><a href="/petani" class="text-muted fw-light"> Data Petani / </a><a onClick={()=>handleBack(user_id, nama)} style={{ cursor:'pointer' }} class="text-muted fw-light"> Kebun /</a> Tambah Data</h4>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form onSubmit={tambahKebun} encType="multipart/form-data">
                                                    <div className="row mb-3">
                                                        <div className="col-md-6">
                                                            <h4 class="modal-title" id="staticBackdropLabel">Tambah Data Kebun</h4>
                                                        </div>
                                                    ...
                                                    <div className="row mb-3">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input onChange={(e) => setnama_kebun(e.target.value)} type="text" class="form-control" id="inputEmail4" autoFocus required/>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="inputPassword4" class="form-label">Pemilik Kebun</label>
                                                            <input onChange={(e) => setnama_pemilik(e.target.value)} type="text" class="form-control" id="inputPassword4" required/>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <option value="" selected>--Pilih Jenis Kebun--</option>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input onChange={(e) => setluas(e.target.value)} type="number" class="form-control" id="inputEmail4" required/>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label for="inputState" class="form-label">Satuan</label>
                                                            <select onChange={(e) => setsatuan(e.target.value)} id="inputState" class="form-select text-gray" required>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input onChange={(e) => settgl_dibuat(e.target.value)} type="date" class="form-control" id="inputEmail4" required/>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                            <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                                                            <textarea onChange={(e) => setalamat(e.target.value)} class="form-control" id="exampleTextarea" rows="2" required></textarea>
                                                        </div>
